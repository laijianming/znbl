...
import com.znbl.common.utils.Collections3;
import com.znbl.common.utils.excel.annotation.ExcelField;
...
public class User extends DataEntity<User> {
    ...
    @ExcelField(title="用户行业归类", align=2, sort=60)
	public String getRemarks() {
		return remarks;
	}

	@ExcelField(title="注册时间", type=0, align=1, sort=90)
	...
	public boolean isOrdinaryUsers(String userType)
	{
		return userType != null && "7".equals(userType);
		//return isOrdinaryUsers(this.userType);
	} 
	
/*	public static boolean isOrdinaryUsers(String userType){
		return userType != null && "7".equals(userType);
	}*/
