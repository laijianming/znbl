...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/sys/sysPic/">图册列表</a></li>
		<li class="active"><a href="${ctx}/sys/sysPic/form?id=${sysPic.id}&parent.id=${sysPicparent.id}"><shiro:hasPermission name="sys:sysPic:edit">${not empty sysPic.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="sys:sysPic:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="sysPic" action="${ctx}/sys/sysPic/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
