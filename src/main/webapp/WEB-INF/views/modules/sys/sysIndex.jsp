	...
	<div id="main">
		<div id="header" class="navbar navbar-fixed-top">
			<div class="navbar-inner">
				<div class="brand"><img alt="" src="${ctxStatic}/images/logo.png" />&nbsp;&nbsp;<span id="productName">${fns:getConfig('productName')}</span></div>
				...
				<div class="nav-collapse" style="padding-top:25px">
	    ...
	    <div class="container-fluid">
		    ...
		    <div id="footer" class="row-fluid" >
	            <span style="color:red;">${fns:getConfig('productName')}
	            ${fns:getConfig('version')}</span><br> Copyright &copy; 2016-${fns:getConfig('copyrightYear')} 将保留最终的解释权
