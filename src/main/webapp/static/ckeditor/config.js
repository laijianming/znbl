...
CKEDITOR.editorConfig = function( config ) {
	...
	config.extraPlugins = 'tableresize,video';
	...
	if(config.ckfinderPath){
        ...
        config.filebrowserVideoBrowseUrl = config.ckfinderPath+'/ckfinder.html?type=video&start=video:'+config.ckfinderUploadPath;
