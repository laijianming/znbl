(function () {
    ...
    var p = "push", h = "hash", ha = "slice", q = "data", r = "cookie", t = "indexOf", m = "match", ia = "defaultValue", ja = "port", u = "createElement", ka = "referrer", v = "name", da = "getTime", x = "host", y = "length", z = "prototype", la = "clientWidth", A = "split", B = "location", ma = "hostname", ga = "search", C = "call", E = "protocol", na = "clientHeight", Ab = "href", F = "substring", G = "apply", oa = "navigator", Ub = "parentNode", H = "join", I = "toLowerCase";
    var pa = new function () {
        var a = [];
        this.set = function (b) {
            a[b] = !0;
    ...
    var O = f, M = document, xa = function (a) {
        ...
        return b && b.ioo && b.ioo() || a && !0 === O["ga-disable-" + a];
    }, fb = function (a) {
        ba(a, 100);
    }, ya = function (a) {
        var b = [], c = M[r][A](";");
    ...
    var oc = function () {
        ...
        if (d) c = new d(), c.open("POST", oc() + "/collect"); else if (d = O.XMLHttpRequest) d = new d(),
            "withCredentials" in d && (c = d, c.open("POST", oc() + "/collect", !0), c.setRequestHeader("Content-Type", "text/plain"));
    ...
    function Pa(a) {
        ...
        Qa.map(function (c, d) {
            if (d.p) {
                var e = a.get(c);
                void 0 == e || e == d[ia] || qa(e) && 0 == e[y] || ("boolean" == typeof e && (e *= 1),
                    b[p](d.p + "=" + sa("" + e)));
            }
        });
        b[p]("z=" + ra());
    ...
    var Qb = T("oot"), Rb = S("checkProtocolTask"), Sb = S("checkStorageTask"), Uc = S("historyImportTask"), Tb = S("samplerTask"), Vb = T("rateLimiterTask"), Wb = S("buildHitTask"), Xb = S("sendHitTask"), Vc = S("ceTask"), V = T("name"), Q = T("clientId", "cid"), Na = T("trackingId", "tid"), U = T("cookieName", void 0, "_ga"), W = T("cookieDomain"), Yb = T("cookiePath", void 0, "/"), Zb = T("cookieExpires", void 0, 63072e3), $b = T("legacyCookieDomain"), Wc = T("legacyHistoryImport", void 0, !0), ac = T("storage", void 0, "cookie"), bc = T("allowLinker", void 0, !1), cc = T("allowAnchor", void 0, !0), Ka = T("sampleRate", "sf", 100), dc = T("siteSpeedSampleRate", void 0, 1), ec = T("alwaysSendReferrer", void 0, !1);
    ...
    function X(a, b, c, d) {
        b[a] = function () {
            try {
                ...
                var g = b && b[v];
                if (!(1 <= 100 * n.random())) {
                    var ca = [ "t=error", "_e=exc", "_v=j10", "sr=1" ];
                    a && ca[p]("_f=" + a);
    ...
    var gc = function (a, b) {
        ...
        if (!(La(P(a, Q)) % 100 >= c) && (c = {}, Ec(c) || Fc(c))) {
            ...
            void 0 == d || Infinity == d || isNaN(d) || (0 < d ? (Y(c, Gb), Y(c, Jb), Y(c, Ib),
                Y(c, Fb), Y(c, Hb), Y(c, Kb), Y(c, Lb), b(c)) : ta(O, "load", function () {
                gc(a, b);
            }, !1));
        }
    }, Ec = function (a) {
    ...
    var ad, bd = function (a, b, c) {
        if (!ad) {
            ...
            if (e = (d = (d = d && d[m](g) || e && e[m](g)) ? d[1] : ya("GASO")[0] || "") && d[m](/^(?:!([-0-9a-z.]{1,40})!)?([-.\w]{10,1200})$/i)) zc("GASO", "" + d, c, b, a, 0),
                f._udo || (f._udo = b), f._utcp || (f._utcp = c), a = e[1], vc("https://www.google.com/analytics/web/inpage/pub/inpage.js?" + (a ? "prefix=" + a + "&" : "") + ra(), "_gasojs");
            ad = !0;
        }
    };
    var pc = function (a) {
            ...
            i:{
                ...
                if (d && !(1 > d[y])) {
                    ...
                    for (var e = 0; e < d[y]; e++) {
                        ...
                        g = d[e][A](".");
                        var ca = g.shift();
                        ("GA1" == ca || "1" == ca) && 1 < g[y] ? (ca = g.shift()[A]("-"), 1 == ca[y] && (ca[1] = "1"),
                            ca[0] *= 1, ca[1] *= 1, g = {
                            r: ca,
                            s: g[H](".")
                        }) : g = void 0;
        ...
        if (e = (c = M[B][Ab][m]("(?:&|\\?)_ga=([^&]*)")) && 2 == c[y] ? c[1] : "") a.get(bc) ? (c = e[t]("."),
            -1 == c ? J(22) : (d = e[F](c + 1), "1" != e[F](0, c) ? J(22) : (c = d[t]("."), -1 == c ? J(22) : (e = d[F](0, c),
                c = d[F](c + 1), e != Ic(c, 0) && e != Ic(c, -1) && e != Ic(c, -2) ? J(23) : (J(11),
                a[q].set(Q, c)))))) : J(21);
        b && (J(9), a[q].set(Q, sa(b)));
        if (!a.get(Q)) if (c = (c = O.gaGlobal && O.gaGlobal.vid) && -1 != c[ga](/^(?:utma\.)?\d+\.\d+$/) ? c : void 0) J(17),
            a[q].set(Q, c); else {
            J(8);
            c = O[oa];
    ...
    pc[z].send = function (a) {
        if (!(1 > arguments[y])) {
            var b, c;
            "string" === typeof arguments[0] ? (b = arguments[0], c = [][ha][C](arguments, 1)) : (b = arguments[0] && arguments[0][Va],
                c = arguments);
            b && (c = wa(qc[b] || [], c), c[Va] = b, this.b.set(c, void 0, !0), this.filters.execute(this.b),
                "pageview" == b && Lc(this), this.b[q].m = {});
        }
    };
    var Lc = function (a) {
    ...
    var sc = function (a) {
        if (K(a[0])) this.u = a[0]; else {
            var b = Z.D.exec(a[0]);
            null != b && 4 == b[y] && (this.c = b[1] || "t0", this.e = b[2] || "", this.d = b[3],
                this.a = [][ha][C](a, 1), this.e || (this.A = "create" == this.d, this.i = "require" == this.d,
                    ...
                    if (!K(Z.k.get(d.a[0])) && !d.H && e) {
                        ...
                        if (s = l) {
                            ...
                            if (g.G || 0 <= g.url[t]("?") || 0 <= g.path[t]("://")) s = !1; else if (g[x] == D[x] && g[ja] == D[ja]) s = !0; else {
                                ...
                                s = "www.google-analytics.com" == g[x] && (g[ja] || vb) == vb && 0 == g.path[t]("/plugins/") ? !0 : !1;
                            }
                        }
                        s && (d.H = !!vc(ca.url));
                    }
    ...
    function La(a) {
        var b = 1, c = 0, d;
        if (a) for (b = 0, d = a[y] - 1; 0 <= d; d--) c = a.charCodeAt(d), b = (b << 6 & 268435455) + c + (c << 14),
